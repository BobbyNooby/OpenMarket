// Color helpers for the site theme system.
// Theme variables are stored in the DB as HSL triplets like "217.2 91.2% 59.8%"
// (matching the format shadcn-svelte uses inside `hsl(var(--primary))`).
// Admins typically pick colors as hex, so we convert in both directions.
